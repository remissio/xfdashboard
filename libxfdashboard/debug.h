 ...
 * @XFDASHBOARD_DEBUG_LAYOUT: Layout at actor debug messages (constructing layoutable actors implementing XfdashboardLayoutable interface via theme or fallback function)
 *
 * Debug categories
 */
